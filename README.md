...
| [beets](charts/beets) | 0.2.4 | Helm chart for beets — the music geek's media organizer. Runs as a Kubernetes CronJob to periodically import and tag new music files. |
